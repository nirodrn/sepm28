...
import { Archive, Send, ArrowLeft, Plus, Trash2, AlertTriangle, ShoppingCart } from 'lucide-react';
import { packingMaterialRequestService } from '../../services/packingMaterialRequestService';
import { materialService } from '../../services/materialService';

const RequestFromWarehouse = () => {
  const navigate = useNavigate();
  const [requestItems, setRequestItems] = useState([
    { id: 1, materialId: '', materialName: '', quantity: '', unit: '', urgency: 'normal', reason: '' }
  ]);
  ...
  const addItem = () => {
    ...
    setRequestItems([
      ...requestItems,
      { id: newId, materialId: '', materialName: '', quantity: '', unit: '', urgency: 'normal', reason: '' }
    ]);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (requestData.materials.length === 0) {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 flex items-center">
              ...
              Request Packing Materials from Warehouse
            </h1>
            <p className="text-gray-600 mt-2">Submit request to Warehouse Staff for packing materials</p>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-yellow-700 text-sm">
                    No packing materials are currently available in the system. Please contact an administrator to add materials first.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-blue-800 font-medium">Request to Warehouse</p>
                <p className="text-blue-700 text-sm">
                  This request will be sent to Warehouse Staff for processing. Head of Operations will be notified for approval.
                </p>
              </div>
            </div>
          </div>
...
export default RequestFromWarehouse;