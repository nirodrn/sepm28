...
const EditProductionProduct = () => {
  ...
  const loadData = async () => {
    try {
      ...
      setAvailableMaterials(materialData.filter(m => m.status === 'active'));
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await productionService.updateProductionProduct(id, productData);
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 flex items-center">
              ...
              Edit Production Product
            </h1>
            <p className="text-gray-600 mt-2">Update product information and material requirements</p>
          </div>
        </div>
      </div>
...
export default EditProductionProduct;