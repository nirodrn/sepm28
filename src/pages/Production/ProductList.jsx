...
import { Package, Plus, Search, Filter, Edit, Trash2, Eye, Factory } from 'lucide-react';
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage products and their material requirements</p>
          </div>
          <button
